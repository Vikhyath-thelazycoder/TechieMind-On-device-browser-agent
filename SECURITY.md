...
We take the security of TechieMind seriously. If you believe you've found a security vulnerability in our code, please follow these steps:

1. **Do not disclose the vulnerability publicly**, including filing a public issue on GitHub.
2. Report via GitHub Private Vulnerability Reporting on the repository.
