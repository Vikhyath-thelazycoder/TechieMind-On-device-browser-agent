...
export const browserUseSystemPrompt = definePrompt(async (tools: PromptBasedTool<string, PromptBasedToolParams>[]) => {
  const system = `You are an intelligent AI assistant integrated into a browser extension called TechieMind. Your primary role is to help users to use browser tools to resolve their queries.
